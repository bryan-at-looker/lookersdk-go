 ...
 * @param "MergeQuery" (optional.Interface of MergeQuery) -  Merge Query
@return MergeQuery
*/
func (a *QueryApiService) CreateMergeQuery(ctx _context.Context, localVarOptionals *CreateMergeQueryOpts) (MergeQuery, *_nethttp.Response, error) {
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.MergeQuery.IsSet() {
		localVarOptionalMergeQuery, localVarOptionalMergeQueryok := localVarOptionals.MergeQuery.Value().(MergeQuery)
		if !localVarOptionalMergeQueryok {
			return localVarReturnValue, nil, reportError("mergeQuery should be MergeQuery")
		}
		localVarPostBody = &localVarOptionalMergeQuery
	}
...
@return Query
*/
func (a *QueryApiService) CreateQuery(ctx _context.Context, query Query, localVarOptionals *CreateQueryOpts) (Query, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return QueryTask
*/
func (a *QueryApiService) CreateQueryTask(ctx _context.Context, createQueryTask CreateQueryTask, localVarOptionals *CreateQueryTaskOpts) (QueryTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &createQueryTask
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return SqlQuery
*/
func (a *QueryApiService) CreateSqlQuery(ctx _context.Context, sqlQueryCreate SqlQueryCreate) (SqlQuery, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &sqlQueryCreate
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return string
*/
func (a *QueryApiService) RunInlineQuery(ctx _context.Context, resultFormat string, query Query, localVarOptionals *RunInlineQueryOpts) (string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
