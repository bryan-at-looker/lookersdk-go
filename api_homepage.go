...
@return Homepage
*/
func (a *HomepageApiService) CreateHomepage(ctx _context.Context, homepage Homepage, localVarOptionals *CreateHomepageOpts) (Homepage, *_nethttp.Response, error) {
	var (
...
@return HomepageItem
*/
func (a *HomepageApiService) CreateHomepageItem(ctx _context.Context, homepageItem HomepageItem, localVarOptionals *CreateHomepageItemOpts) (HomepageItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return HomepageSection
*/
func (a *HomepageApiService) CreateHomepageSection(ctx _context.Context, homepageSection HomepageSection, localVarOptionals *CreateHomepageSectionOpts) (HomepageSection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &homepageSection
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return Homepage
*/
func (a *HomepageApiService) UpdateHomepage(ctx _context.Context, homepageId int64, homepage Homepage, localVarOptionals *UpdateHomepageOpts) (Homepage, *_nethttp.Response, error) {
	var (
...
@return HomepageItem
*/
func (a *HomepageApiService) UpdateHomepageItem(ctx _context.Context, homepageItemId int64, homepageItem HomepageItem, localVarOptionals *UpdateHomepageItemOpts) (HomepageItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return HomepageSection
*/
func (a *HomepageApiService) UpdateHomepageSection(ctx _context.Context, homepageSectionId int64, homepageSection HomepageSection, localVarOptionals *UpdateHomepageSectionOpts) (HomepageSection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
