 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param lookmlModel LookML Model
@return LookmlModel
*/
func (a *LookmlModelApiService) CreateLookmlModel(ctx _context.Context, lookmlModel LookmlModel) (LookmlModel, *_nethttp.Response, error) {
	var (
...
@return LookmlModel
*/
func (a *LookmlModelApiService) UpdateLookmlModel(ctx _context.Context, lookmlModelName string, lookmlModel LookmlModel) (LookmlModel, *_nethttp.Response, error) {
	var (
