...
type ColorCollection struct {
	...
	CategoricalPalettes []DiscretePalette `json:"categoricalPalettes,omitempty"`
	// Array of discrete palette definitions
	SequentialPalettes []ContinuousPalette `json:"sequentialPalettes,omitempty"`
	// Array of diverging palette definitions
	DivergingPalettes []ContinuousPalette `json:"divergingPalettes,omitempty"`
}
