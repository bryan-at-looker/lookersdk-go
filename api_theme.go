...
@return Theme
*/
func (a *ThemeApiService) CreateTheme(ctx _context.Context, theme Theme) (Theme, *_nethttp.Response, error) {
	var (
...
@return Theme
*/
func (a *ThemeApiService) UpdateTheme(ctx _context.Context, themeId string, theme Theme) (Theme, *_nethttp.Response, error) {
	var (
...
*/
func (a *ThemeApiService) ValidateTheme(ctx _context.Context, theme Theme) (ValidationError, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
