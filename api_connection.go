...
@return DbConnection
*/
func (a *ConnectionApiService) CreateConnection(ctx _context.Context, dbConnection DbConnection) (DbConnection, *_nethttp.Response, error) {
	var (
...
@return []DbConnectionTestResult
*/
func (a *ConnectionApiService) TestConnectionConfig(ctx _context.Context, dbConnection DbConnection, localVarOptionals *TestConnectionConfigOpts) ([]DbConnectionTestResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return DbConnection
*/
func (a *ConnectionApiService) UpdateConnection(ctx _context.Context, connectionName string, dbConnection DbConnection) (DbConnection, *_nethttp.Response, error) {
	var (
