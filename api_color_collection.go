...
@return ColorCollection
*/
func (a *ColorCollectionApiService) CreateColorCollection(ctx _context.Context, colorCollection ColorCollection) (ColorCollection, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &colorCollection
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return ColorCollection
*/
func (a *ColorCollectionApiService) UpdateColorCollection(ctx _context.Context, collectionId string, colorCollection ColorCollection) (ColorCollection, *_nethttp.Response, error) {
	var (
