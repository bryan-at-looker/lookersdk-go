...
@return Group
*/
func (a *GroupApiService) AddGroupGroup(ctx _context.Context, groupId int64, groupIdForGroupInclusion GroupIdForGroupInclusion) (Group, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &groupIdForGroupInclusion
...
@return User
*/
func (a *GroupApiService) AddGroupUser(ctx _context.Context, groupId int64, groupIdForGroupUserInclusion GroupIdForGroupUserInclusion) (User, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &groupIdForGroupUserInclusion
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return Group
*/
func (a *GroupApiService) CreateGroup(ctx _context.Context, group Group, localVarOptionals *CreateGroupOpts) (Group, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Group
*/
func (a *GroupApiService) UpdateGroup(ctx _context.Context, groupId int64, group Group, localVarOptionals *UpdateGroupOpts) (Group, *_nethttp.Response, error) {
	var (
 ...
 * @param groupId Id of group
 * @param userAttributeId Id of user attribute
 * @param userAttributeGroupValue New value for group.
@return UserAttributeGroupValue
*/
func (a *GroupApiService) UpdateUserAttributeGroupValue(ctx _context.Context, groupId int64, userAttributeId int64, userAttributeGroupValue UserAttributeGroupValue) (UserAttributeGroupValue, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &userAttributeGroupValue
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
