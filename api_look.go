...
*/
func (a *LookApiService) CreateLook(ctx _context.Context, lookWithQuery LookWithQuery, localVarOptionals *CreateLookOpts) (LookWithQuery, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &lookWithQuery
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return LookWithQuery
*/
func (a *LookApiService) UpdateLook(ctx _context.Context, lookId int64, lookWithQuery LookWithQuery, localVarOptionals *UpdateLookOpts) (LookWithQuery, *_nethttp.Response, error) {
	var (
