...
@return IntegrationHub
*/
func (a *IntegrationApiService) CreateIntegrationHub(ctx _context.Context, integrationHub IntegrationHub, localVarOptionals *CreateIntegrationHubOpts) (IntegrationHub, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &integrationHub
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
*/
func (a *IntegrationApiService) FetchIntegrationForm(ctx _context.Context, integrationId string) (DataActionForm, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Integration
*/
func (a *IntegrationApiService) UpdateIntegration(ctx _context.Context, integrationId string, integration Integration, localVarOptionals *UpdateIntegrationOpts) (Integration, *_nethttp.Response, error) {
	var (
...
@return IntegrationHub
*/
func (a *IntegrationApiService) UpdateIntegrationHub(ctx _context.Context, integrationHubId int64, integrationHub IntegrationHub, localVarOptionals *UpdateIntegrationHubOpts) (IntegrationHub, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
