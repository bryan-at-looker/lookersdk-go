 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contentFavorite Favorite Content
@return ContentFavorite
*/
func (a *ContentApiService) CreateContentFavorite(ctx _context.Context, contentFavorite ContentFavorite) (ContentFavorite, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &contentFavorite
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return ContentMetaGroupUser
*/
func (a *ContentApiService) CreateContentMetadataAccess(ctx _context.Context, contentMetaGroupUser ContentMetaGroupUser, localVarOptionals *CreateContentMetadataAccessOpts) (ContentMetaGroupUser, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &contentMetaGroupUser
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return ContentMeta
*/
func (a *ContentApiService) UpdateContentMetadata(ctx _context.Context, contentMetadataId int64, contentMeta ContentMeta) (ContentMeta, *_nethttp.Response, error) {
	var (
...
@return ContentMetaGroupUser
*/
func (a *ContentApiService) UpdateContentMetadataAccess(ctx _context.Context, contentMetadataAccessId int64, contentMetaGroupUser ContentMetaGroupUser) (ContentMetaGroupUser, *_nethttp.Response, error) {
	var (
