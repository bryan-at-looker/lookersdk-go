...
@return GitBranch
*/
func (a *ProjectApiService) CreateGitBranch(ctx _context.Context, projectId string, gitBranch GitBranch) (GitBranch, *_nethttp.Response, error) {
	var (
...
@return Project
*/
func (a *ProjectApiService) CreateProject(ctx _context.Context, project Project) (Project, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return GitBranch
*/
func (a *ProjectApiService) UpdateGitBranch(ctx _context.Context, projectId string, gitBranch GitBranch) (GitBranch, *_nethttp.Response, error) {
	var (
...
@return Project
*/
func (a *ProjectApiService) UpdateProject(ctx _context.Context, projectId string, project Project, localVarOptionals *UpdateProjectOpts) (Project, *_nethttp.Response, error) {
	var (
 ...
 * @param rootProjectId Root Project Id
 * @param credentialId Credential Id
 * @param repositoryCredential Remote Project Information
@return RepositoryCredential
*/
func (a *ProjectApiService) UpdateRepositoryCredential(ctx _context.Context, rootProjectId string, credentialId string, repositoryCredential RepositoryCredential) (RepositoryCredential, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &repositoryCredential
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
