...
@return BackupConfiguration
*/
func (a *ConfigApiService) UpdateBackupConfiguration(ctx _context.Context, backupConfiguration BackupConfiguration) (BackupConfiguration, *_nethttp.Response, error) {
	var (
...
@return CustomWelcomeEmail
*/
func (a *ConfigApiService) UpdateCustomWelcomeEmail(ctx _context.Context, customWelcomeEmail CustomWelcomeEmail, localVarOptionals *UpdateCustomWelcomeEmailOpts) (CustomWelcomeEmail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &customWelcomeEmail
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
*/
func (a *ConfigApiService) UpdateCustomWelcomeEmailTest(ctx _context.Context, welcomeEmailTest WelcomeEmailTest) (WelcomeEmailTest, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &welcomeEmailTest
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return DigestEmails
*/
func (a *ConfigApiService) UpdateDigestEmailsEnabled(ctx _context.Context, digestEmails DigestEmails) (DigestEmails, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return InternalHelpResources
*/
func (a *ConfigApiService) UpdateInternalHelpResources(ctx _context.Context, internalHelpResources InternalHelpResources) (InternalHelpResources, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &internalHelpResources
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return InternalHelpResourcesContent
*/
func (a *ConfigApiService) UpdateInternalHelpResourcesContent(ctx _context.Context, internalHelpResourcesContent InternalHelpResourcesContent) (InternalHelpResourcesContent, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &internalHelpResourcesContent
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return LegacyFeature
*/
func (a *ConfigApiService) UpdateLegacyFeature(ctx _context.Context, legacyFeatureId int64, legacyFeature LegacyFeature) (LegacyFeature, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &legacyFeature
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
*/
func (a *ConfigApiService) UpdateWhitelabelConfiguration(ctx _context.Context, whitelabelConfiguration WhitelabelConfiguration) (WhitelabelConfiguration, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &whitelabelConfiguration
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
