...
@return UserAttribute
*/
func (a *UserAttributeApiService) CreateUserAttribute(ctx _context.Context, userAttribute UserAttribute, localVarOptionals *CreateUserAttributeOpts) (UserAttribute, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &userAttribute
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userAttributeId Id of user attribute
 * @param userAttributeGroupValue Array of group values.
@return []UserAttributeGroupValue
*/
func (a *UserAttributeApiService) SetUserAttributeGroupValues(ctx _context.Context, userAttributeId int64, userAttributeGroupValue []UserAttributeGroupValue) ([]UserAttributeGroupValue, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return UserAttribute
*/
func (a *UserAttributeApiService) UpdateUserAttribute(ctx _context.Context, userAttributeId int64, userAttribute UserAttribute, localVarOptionals *UpdateUserAttributeOpts) (UserAttribute, *_nethttp.Response, error) {
	var (
