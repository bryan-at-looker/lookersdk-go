 ...
 **mergeQuery** | [**optional.Interface of MergeQuery**](MergeQuery.md)| Merge Query | 
...
> Query CreateQuery(ctx, query, optional)
...
> QueryTask CreateQueryTask(ctx, createQueryTask, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**createQueryTask** | [**CreateQueryTask**](CreateQueryTask.md)| Query parameters | 
...
> SqlQuery CreateSqlQuery(ctx, sqlQueryCreate)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**sqlQueryCreate** | [**SqlQueryCreate**](SqlQueryCreate.md)| SQL Runner Query | 
...
> string RunInlineQuery(ctx, resultFormat, query, optional)
...
**query** | [**Query**](Query.md)| inline query | 
