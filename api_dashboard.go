...
@return Dashboard
*/
func (a *DashboardApiService) CreateDashboard(ctx _context.Context, dashboard Dashboard) (Dashboard, *_nethttp.Response, error) {
	var (
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dashboardElement DashboardElement
 * @param optional nil or *CreateDashboardElementOpts - Optional Parameters:
 * @param "Fields" (optional.String) -  Requested fields.
@return DashboardElement
*/
func (a *DashboardApiService) CreateDashboardElement(ctx _context.Context, dashboardElement DashboardElement, localVarOptionals *CreateDashboardElementOpts) (DashboardElement, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &dashboardElement
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param createDashboardFilter Dashboard Filter
 * @param optional nil or *CreateDashboardFilterOpts - Optional Parameters:
 * @param "Fields" (optional.String) -  Requested fields
@return DashboardFilter
*/
func (a *DashboardApiService) CreateDashboardFilter(ctx _context.Context, createDashboardFilter CreateDashboardFilter, localVarOptionals *CreateDashboardFilterOpts) (DashboardFilter, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &createDashboardFilter
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
*/
func (a *DashboardApiService) CreateDashboardLayout(ctx _context.Context, dashboardLayout DashboardLayout, localVarOptionals *CreateDashboardLayoutOpts) (DashboardLayout, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &dashboardLayout
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
 ...
 * @param "Dashboard" (optional.Interface of Dashboard) -  Dashboard
@return Dashboard
*/
...
@return []int64
*/
func (a *DashboardApiService) SyncLookmlDashboard(ctx _context.Context, lookmlDashboardId string, dashboard Dashboard, localVarOptionals *SyncLookmlDashboardOpts) ([]int64, *_nethttp.Response, error) {
	var (
...
@return Dashboard
*/
func (a *DashboardApiService) UpdateDashboard(ctx _context.Context, dashboardId string, dashboard Dashboard) (Dashboard, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return DashboardElement
*/
func (a *DashboardApiService) UpdateDashboardElement(ctx _context.Context, dashboardElementId string, dashboardElement DashboardElement, localVarOptionals *UpdateDashboardElementOpts) (DashboardElement, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return DashboardFilter
*/
func (a *DashboardApiService) UpdateDashboardFilter(ctx _context.Context, dashboardFilterId string, dashboardFilter DashboardFilter, localVarOptionals *UpdateDashboardFilterOpts) (DashboardFilter, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &dashboardFilter
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return DashboardLayout
*/
func (a *DashboardApiService) UpdateDashboardLayout(ctx _context.Context, dashboardLayoutId string, dashboardLayout DashboardLayout, localVarOptionals *UpdateDashboardLayoutOpts) (DashboardLayout, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dashboardLayoutComponentId Id of dashboard layout component
 * @param dashboardLayoutComponent DashboardLayoutComponent
 * @param optional nil or *UpdateDashboardLayoutComponentOpts - Optional Parameters:
 * @param "Fields" (optional.String) -  Requested fields.
@return DashboardLayoutComponent
*/
func (a *DashboardApiService) UpdateDashboardLayoutComponent(ctx _context.Context, dashboardLayoutComponentId string, dashboardLayoutComponent DashboardLayoutComponent, localVarOptionals *UpdateDashboardLayoutComponentOpts) (DashboardLayoutComponent, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &dashboardLayoutComponent
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
