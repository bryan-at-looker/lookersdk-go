 ...
 * @param "Fields" (optional.String) -  Requested fields.
 * @param "CredentialsApi3" (optional.Interface of CredentialsApi3) -  API 3 Credential
@return CredentialsApi3
*/
func (a *UserApiService) CreateUserCredentialsApi3(ctx _context.Context, userId int64, localVarOptionals *CreateUserCredentialsApi3Opts) (CredentialsApi3, *_nethttp.Response, error) {
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CredentialsApi3.IsSet() {
		localVarOptionalCredentialsApi3, localVarOptionalCredentialsApi3ok := localVarOptionals.CredentialsApi3.Value().(CredentialsApi3)
		if !localVarOptionalCredentialsApi3ok {
			return localVarReturnValue, nil, reportError("credentialsApi3 should be CredentialsApi3")
		}
		localVarPostBody = &localVarOptionalCredentialsApi3
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId id of user
 * @param credentialsEmail Email/Password Credential
 * @param optional nil or *CreateUserCredentialsEmailOpts - Optional Parameters:
 * @param "Fields" (optional.String) -  Requested fields.
@return CredentialsEmail
*/
func (a *UserApiService) CreateUserCredentialsEmail(ctx _context.Context, userId int64, credentialsEmail CredentialsEmail, localVarOptionals *CreateUserCredentialsEmailOpts) (CredentialsEmail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &credentialsEmail
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
 ...
 * @param "Fields" (optional.String) -  Requested fields.
 * @param "CredentialsTotp" (optional.Interface of CredentialsTotp) -  Two-Factor Credential
...
func (a *UserApiService) CreateUserCredentialsTotp(ctx _context.Context, userId int64, localVarOptionals *CreateUserCredentialsTotpOpts) (CredentialsTotp, *_nethttp.Response, error) {
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.CredentialsTotp.IsSet() {
		localVarOptionalCredentialsTotp, localVarOptionalCredentialsTotpok := localVarOptionals.CredentialsTotp.Value().(CredentialsTotp)
		if !localVarOptionalCredentialsTotpok {
			return localVarReturnValue, nil, reportError("credentialsTotp should be CredentialsTotp")
		}
		localVarPostBody = &localVarOptionalCredentialsTotp
	}
 ...
 * @param userId Id of user
 * @param userAttributeId Id of user attribute
 * @param userAttributeWithValue New attribute value for user.
@return UserAttributeWithValue
*/
func (a *UserApiService) SetUserAttributeUserValue(ctx _context.Context, userId int64, userAttributeId int64, userAttributeWithValue UserAttributeWithValue) (UserAttributeWithValue, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &userAttributeWithValue
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return []Role
*/
func (a *UserApiService) SetUserRoles(ctx _context.Context, userId int64, requestBody []int64, localVarOptionals *SetUserRolesOpts) ([]Role, *_nethttp.Response, error) {
	var (
...
@return User
*/
func (a *UserApiService) UpdateUser(ctx _context.Context, userId int64, user User, localVarOptionals *UpdateUserOpts) (User, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return CredentialsEmail
*/
func (a *UserApiService) UpdateUserCredentialsEmail(ctx _context.Context, userId int64, credentialsEmail CredentialsEmail, localVarOptionals *UpdateUserCredentialsEmailOpts) (CredentialsEmail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
