...
@return ModelSet
*/
func (a *RoleApiService) CreateModelSet(ctx _context.Context, modelSet ModelSet) (ModelSet, *_nethttp.Response, error) {
	var (
...
@return PermissionSet
*/
func (a *RoleApiService) CreatePermissionSet(ctx _context.Context, permissionSet PermissionSet) (PermissionSet, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &permissionSet
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return Role
*/
func (a *RoleApiService) CreateRole(ctx _context.Context, role Role) (Role, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return []Group
*/
func (a *RoleApiService) SetRoleGroups(ctx _context.Context, roleId int64, requestBody []int64) ([]Group, *_nethttp.Response, error) {
	var (
...
@return []User
*/
func (a *RoleApiService) SetRoleUsers(ctx _context.Context, roleId int64, requestBody []int64) ([]User, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return ModelSet
*/
func (a *RoleApiService) UpdateModelSet(ctx _context.Context, modelSetId int64, modelSet ModelSet) (ModelSet, *_nethttp.Response, error) {
	var (
...
@return PermissionSet
*/
func (a *RoleApiService) UpdatePermissionSet(ctx _context.Context, permissionSetId int64, permissionSet PermissionSet) (PermissionSet, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Role
*/
func (a *RoleApiService) UpdateRole(ctx _context.Context, roleId int64, role Role) (Role, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
