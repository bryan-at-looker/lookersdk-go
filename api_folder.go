 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param createFolder Folder parameters
@return Folder
*/
func (a *FolderApiService) CreateFolder(ctx _context.Context, createFolder CreateFolder) (Folder, *_nethttp.Response, error) {
	var (
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param folderId Id of folder
 * @param updateFolder Folder parameters
@return Folder
*/
func (a *FolderApiService) UpdateFolder(ctx _context.Context, folderId string, updateFolder UpdateFolder) (Folder, *_nethttp.Response, error) {
	var (
