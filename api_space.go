...
@return Space
*/
func (a *SpaceApiService) CreateSpace(ctx _context.Context, createSpace CreateSpace) (Space, *_nethttp.Response, error) {
	var (
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param spaceId Id of space
 * @param updateSpace Space parameters
@return Space
*/
func (a *SpaceApiService) UpdateSpace(ctx _context.Context, spaceId string, updateSpace UpdateSpace) (Space, *_nethttp.Response, error) {
	var (
