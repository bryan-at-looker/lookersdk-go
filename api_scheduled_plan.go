 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param scheduledPlan Scheduled Plan
@return ScheduledPlan
*/
func (a *ScheduledPlanApiService) CreateScheduledPlan(ctx _context.Context, scheduledPlan ScheduledPlan) (ScheduledPlan, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &scheduledPlan
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return ScheduledPlan
*/
func (a *ScheduledPlanApiService) ScheduledPlanRunOnce(ctx _context.Context, scheduledPlan ScheduledPlan) (ScheduledPlan, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
type ScheduledPlanRunOnceByIdOpts struct {
	WriteScheduledPlan optional.Interface
}
 ...
 * @param "WriteScheduledPlan" (optional.Interface of WriteScheduledPlan) -  Property values to apply to the newly copied scheduled plan before running it
@return ScheduledPlan
*/
func (a *ScheduledPlanApiService) ScheduledPlanRunOnceById(ctx _context.Context, scheduledPlanId int64, localVarOptionals *ScheduledPlanRunOnceByIdOpts) (ScheduledPlan, *_nethttp.Response, error) {
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.WriteScheduledPlan.IsSet() {
		localVarOptionalWriteScheduledPlan, localVarOptionalWriteScheduledPlanok := localVarOptionals.WriteScheduledPlan.Value().(WriteScheduledPlan)
		if !localVarOptionalWriteScheduledPlanok {
			return localVarReturnValue, nil, reportError("writeScheduledPlan should be WriteScheduledPlan")
		}
		localVarPostBody = &localVarOptionalWriteScheduledPlan
	}
...
@return ScheduledPlan
*/
func (a *ScheduledPlanApiService) UpdateScheduledPlan(ctx _context.Context, scheduledPlanId int64, scheduledPlan ScheduledPlan) (ScheduledPlan, *_nethttp.Response, error) {
	var (
