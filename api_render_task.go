 ...
 * @param createDashboardRenderTask Dashboard render task parameters
...
@return RenderTask
*/
func (a *RenderTaskApiService) CreateDashboardRenderTask(ctx _context.Context, dashboardId int64, resultFormat string, width int64, height int64, createDashboardRenderTask CreateDashboardRenderTask, localVarOptionals *CreateDashboardRenderTaskOpts) (RenderTask, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &createDashboardRenderTask
...
@return RenderTask
*/
func (a *RenderTaskApiService) CreateLookmlDashboardRenderTask(ctx _context.Context, dashboardId string, resultFormat string, width int64, height int64, createDashboardRenderTask CreateDashboardRenderTask, localVarOptionals *CreateLookmlDashboardRenderTaskOpts) (RenderTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
