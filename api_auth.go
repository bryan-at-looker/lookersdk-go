...
@return OidcConfig
*/
func (a *AuthApiService) CreateOidcTestConfig(ctx _context.Context, oidcConfig OidcConfig) (OidcConfig, *_nethttp.Response, error) {
	var (
...
@return SamlConfig
*/
func (a *AuthApiService) CreateSamlTestConfig(ctx _context.Context, samlConfig SamlConfig) (SamlConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return EmbedSsoUrl
*/
func (a *AuthApiService) CreateSsoEmbedUrl(ctx _context.Context, embedSsoUrlParams EmbedSsoUrlParams) (EmbedSsoUrl, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &embedSsoUrlParams
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
*/
func (a *AuthApiService) TestLdapConfigAuth(ctx _context.Context, ldapConfig LdapConfig) (LdapConfigTestResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return LdapConfigTestResult
*/
func (a *AuthApiService) TestLdapConfigConnection(ctx _context.Context, ldapConfig LdapConfig) (LdapConfigTestResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return LdapConfigTestResult
*/
func (a *AuthApiService) TestLdapConfigUserAuth(ctx _context.Context, ldapConfig LdapConfig) (LdapConfigTestResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return LdapConfigTestResult
*/
func (a *AuthApiService) TestLdapConfigUserInfo(ctx _context.Context, ldapConfig LdapConfig) (LdapConfigTestResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return LdapConfig
*/
func (a *AuthApiService) UpdateLdapConfig(ctx _context.Context, ldapConfig LdapConfig) (LdapConfig, *_nethttp.Response, error) {
	var (
...
@return OidcConfig
*/
func (a *AuthApiService) UpdateOidcConfig(ctx _context.Context, oidcConfig OidcConfig) (OidcConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return PasswordConfig
*/
func (a *AuthApiService) UpdatePasswordConfig(ctx _context.Context, passwordConfig PasswordConfig) (PasswordConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &passwordConfig
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
@return SamlConfig
*/
func (a *AuthApiService) UpdateSamlConfig(ctx _context.Context, samlConfig SamlConfig) (SamlConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return SessionConfig
*/
func (a *AuthApiService) UpdateSessionConfig(ctx _context.Context, sessionConfig SessionConfig) (SessionConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &sessionConfig
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
